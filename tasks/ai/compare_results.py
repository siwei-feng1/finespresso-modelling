...
def main():
    prev_classifier_file = os.path.join(reports_dir, 'model_results_binary_after_cleaning.csv')
    curr_classifier_file = os.path.join(reports_dir, 'model_results_binary_after_features_eng.csv')
    prev_regression_file = os.path.join(reports_dir, 'model_results_regression_after_cleaning.csv')
    curr_regression_file = os.path.join(reports_dir, 'model_results_regression_after_features_eng.csv')
